...
/*
var scores, roundScore, activePlayer, gamePlaying, previousDiceRolls;
startGame();
...
document.querySelector('.btn-roll').addEventListener('click', function () {
    ...
    if(gamePlaying) {
        ...
        // 3. store result into variabele
        //previousDiceRolls.push(dice);
        
        previousDiceRolls[activePlayer].push(dice)
        console.log(previousDiceRolls); 
        ...
        console.log(previousDiceRolls[activePlayer].length-1, previousDiceRolls[activePlayer])
        var activePlayerDices = previousDiceRolls[activePlayer]
        if (activePlayerDices[activePlayerDices.length-1] === 6 && activePlayerDices[activePlayerDices.length-2] === 6) {
            
            // set score of active player to 0 and next players turn
